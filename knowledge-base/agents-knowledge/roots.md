...
- `ROOT_SKILLS` -> `./skills/` - Agent procedural skill definitions.
- `DOC_SKILLS_LIST` -> `./skills/skills.md` - Canonical skill list and descriptions.
- `ROOT_SLASH_COMMANDS` -> `./knowledge-base/slash-commands/prompts/` - Agent slash commands.
...
- `ROOT_KNOWLEDGE_BASE` -> `./knowledge-base/` - Agent-oriented Project-level knowledge, prompts and artifacts.
...
- `KB_API_CONVENTIONS` -> `./knowledge-base/agents-knowledge/api-conventions.md` - REST/API conventions, pagination, and HTTP error mapping.
